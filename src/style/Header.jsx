  ...
  return (
    <>
      ...
      <Sidebar isOpen={isOpen}>
        ...
        {isLogIn ? (
          <>
            <Link to="/mypage" onClick={toggleSidebar} style={{ margin: "0" }}>
              {userInfo.authority}
            </Link>
            <Link
              to="/mypage"
            ...
            >
              {userInfo.userNickname} <span>님</span>
            </Link>
        ...
        <Link to="music" onClick={toggleSidebar}>
          음원
        </Link>
        <Link to="comunitypage" onClick={toggleSidebar}>
          커뮤니티
        </Link>
      </Sidebar>
    </>
